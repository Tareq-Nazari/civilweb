...
namespace Tareghnazari\Category\Http\Controllers;


use App\Http\Controllers\Controller;

use Illuminate\Support\Facades\Request;
use Tareghnazari\Category\Http\Requests\CategoryStoreRequest;
use Tareghnazari\Category\Models\Category;
use Tareghnazari\Category\Repositories\CategoryRepo;
