...
use \Tareghnazari\Course\Http\Controllers\LessonController;

Route::group(["namespace" => "Tareghnazari\Course\Http\Controllers", 'middleware' => ['web', 'auth', 'verified']], function ($router) {
